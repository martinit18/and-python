...
# The following routines have equivalents in the Measurement class, so I think they are now useless
...
# Not currently used, should probably be moved the Io class
...
# Unfortunately, this variable depends on the MPI implementation
...
# The present hack works for MPICH and OpemMPI
# I do not know any mpi4py implementation for IntelMPI (maybe look at the Intel Python distribution)
