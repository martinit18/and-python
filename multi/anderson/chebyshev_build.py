...
inline static void elementary_clenshaw_step_real_real_coef_1d(const int dim_x, const int boundary_condition, const double * restrict wfc, const double * restrict psi, double * restrict psi_old, const double * restrict disorder, const double c_coef, const double c1, const double c2, const double c3)
{
  int i;
...
inline static void elementary_clenshaw_step_real_imag_coef_1d(const int dim_x, const int boundary_condition, const double * restrict wfc, const double * restrict psi, double * restrict psi_old, const double * restrict disorder, const double c_coef, const double c1, const double c2, const double c3)
{
  int i;
// boundary_condition=1 is periodic
// boundary_condition=0 is open
